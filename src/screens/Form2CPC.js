      ...
      facultyData.PaperPresentConference.map((data,index) => (
        <tbody key={index}>
          <tr>
            ...
            <td>{data.selfscore}</td>
            <td>
              {data.PaperPresentConferenceHOD}
            </td>
          </tr>
        </tbody>
      ))
