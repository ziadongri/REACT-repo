...
function Form2BHOD() {
    ...
    const [IIActaSemHOD, setIIActaSemHOD] = useState('');
    const [IIActbSemHOD, setIIActbSemHOD] = useState('');
    const [IIActcSemHOD, setIIActcSemHOD] = useState('');
    const [IIActdSemHOD, setIIActdSemHOD] = useState('');
    const [IIActaHOD, setIIActaHOD] = useState('');
    ...
    const Total = () => {
        setIIActTotalHOD(parseInt(IIActaHOD) + parseInt(IIActbHOD) + parseInt(IIActcHOD) + parseInt(IIActdHOD));
    }

    useEffect(() => {
        Total();
    }
        , [IIActaHOD, IIActbHOD, IIActcHOD, IIActdHOD]);
              ...
              View file here
                          ...
                          <td>
                            <Form.Control
                              ...
                              value={IIActaHOD}
                              onChange={(e) => setIIActaHOD(Math.min(Number(e.target.value), 35))}
                      max={35}
                            />
                          </td>
                        </tr>
              ...
              View file here
                          ...
                          <td>
                            <Form.Control
                              ...
                              value={IIActbHOD}
                              onChange={(e) => setIIActbHOD(Math.min(Number(e.target.value), 25))}
                      max={25}
                            />
                          </td>
                        </tr>
              ...
              View file here
                          ...
                          <td>
                            <Form.Control
                              ...
                              style={{ textAlign: "center" }}
                              value={IIActcHOD}
                              onChange={(e) => setIIActcHOD(Math.min(Number(e.target.value), 20))}
                      max={20}
                            />
                          </td>
                        </tr>
